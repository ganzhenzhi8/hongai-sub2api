...
func (s *OpenAIGatewayService) ReportOpenAIAccountScheduleResult(account *Account, model string, success bool, firstTokenMs *int, observedErr ...error) bool {
	return s.reportOpenAIAccountScheduleResult(account, model, success, firstTokenMs, nil, observedErr...)
}

func (s *OpenAIGatewayService) ReportOpenAIAccountScheduleResultWithContext(account *Account, model string, success bool, firstTokenMs *int, requestCtx context.Context, observedErr ...error) bool {
	return s.reportOpenAIAccountScheduleResult(account, model, success, firstTokenMs, requestCtx, observedErr...)
}

func (s *OpenAIGatewayService) reportOpenAIAccountScheduleResult(account *Account, model string, success bool, firstTokenMs *int, requestCtx context.Context, observedErr ...error) bool {
	if account == nil {
		return false
	}
	accountID := account.ID
