...
func (h *OpenAIGatewayHandler) Responses(c *gin.Context) {
	...
	for {
		...
		if result != nil {
			...
			h.gatewayService.ReportOpenAIAccountScheduleResultWithContext(account, openAIAccountScheduleModel(c, account, forwardModel, requireCompact, result), openAIForwardSucceededForScheduling(result), result.FirstTokenMs, c.Request.Context())
		} else {
			h.gatewayService.ReportOpenAIAccountScheduleResultWithContext(account, openAIAccountScheduleModel(c, account, forwardModel, requireCompact, result), openAIForwardSucceededForScheduling(result), nil, c.Request.Context())
		}
...
func (h *OpenAIGatewayHandler) Messages(c *gin.Context) {
	...
	for {
		...
		if result != nil {
			h.gatewayService.ReportOpenAIAccountScheduleResultWithContext(account, openAIAccountScheduleModel(c, account, currentRoutingModel, false, result), true, result.FirstTokenMs, c.Request.Context())
		} else {
			h.gatewayService.ReportOpenAIAccountScheduleResultWithContext(account, openAIAccountScheduleModel(c, account, currentRoutingModel, false, result), true, nil, c.Request.Context())
		}
	...
	for {
		...
		hooks := &service.OpenAIWSIngressHooks{
			...
			AfterTurn: func(turn int, result *service.OpenAIForwardResult, turnErr error) {
				...
				h.gatewayService.ReportOpenAIAccountScheduleResultWithContext(account, scheduleModel, openAIForwardSucceededForScheduling(result), result.FirstTokenMs, ctx)
				inboundEndpoint := GetInboundEndpoint(c)
