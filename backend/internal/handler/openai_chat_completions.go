...
func (h *OpenAIGatewayHandler) ChatCompletions(c *gin.Context) {
	...
	for {
		...
		if result != nil {
			h.gatewayService.ReportOpenAIAccountScheduleResultWithContext(account, openAIAccountScheduleModel(c, account, reqModel, false, result), true, result.FirstTokenMs, c.Request.Context())
		} else {
			h.gatewayService.ReportOpenAIAccountScheduleResultWithContext(account, openAIAccountScheduleModel(c, account, reqModel, false, result), true, nil, c.Request.Context())
		}
